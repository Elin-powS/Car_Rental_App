...
public class User_Reservation extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressBar = (ProgressBar) findViewById(R.id.AprogressBar);
        progressBar.setVisibility(View.VISIBLE);

        recyclerView = findViewById(R.id.User_Reservations);

        firebaseuser = FirebaseAuth.getInstance().getCurrentUser();
        userID = firebaseuser.getUid();

        databaseReference = FirebaseDatabase.getInstance().getReference("user").child(userID).child("Accepted Reservation Information");
        ...
        Exit=(TextView) findViewById(R.id.AAexit);
        Exit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(User_Reservation.this, "Exit", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(User_Reservation.this, Sign_In.class);
