...
public class Sign_Up extends AppCompatActivity {
    ...
    private EditText Fullname, Email, Date_of_Birth, contact_number,username, password, confirm_password,Address;
    private Button B3;
    ...
    private void updateUi(String uid, String email) {
        ...
        DatabaseReference reference2 = FirebaseDatabase.getInstance().getReference().child("Admin");
        reference2.child("User Informations").push()
                .setValue(map)
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    @Override
                    public void onComplete(@NonNull Task<Void> task) {}
